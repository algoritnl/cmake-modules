...
function(add_custom_configuration_type CCT_BUILD_TYPE)
    ...
    set(CMAKE_C_FLAGS_${build_type} ${c_flags} CACHE STRING
        "Flags used by the C compiler during ${build_type} builds." FORCE)
    mark_as_advanced(CMAKE_C_FLAGS_${build_type})

    string(JOIN " " cxx_flags ${based_on_cxx_flags} ${CCT_CXX_FLAGS})
    set(CMAKE_CXX_FLAGS_${build_type} ${cxx_flags} CACHE STRING
        "Flags used by the CXX compiler during ${build_type} builds." FORCE)
    ...
    set(CMAKE_EXE_LINKER_FLAGS_${build_type} ${exe_linker_flags} CACHE STRING
        "Flags used by the linker during ${build_type} builds." FORCE)
    ...
    set(CMAKE_MODULE_LINKER_FLAGS_${build_type} ${module_linker_flags} CACHE STRING
        "Flags used by the linker during the creation of modules during ${build_type} builds." FORCE)
    ...
    set(CMAKE_SHARED_LINKER_FLAGS_${build_type} ${shared_linker_flags} CACHE STRING
        "Flags used by the linker during the creation of shared libraries during ${build_type} builds." FORCE)
    ...
    set(CMAKE_STATIC_LINKER_FLAGS_${build_type} ${static_linker_flags} CACHE STRING
        "Flags used by the linker during the creation of static libraries during ${build_type} builds." FORCE)
